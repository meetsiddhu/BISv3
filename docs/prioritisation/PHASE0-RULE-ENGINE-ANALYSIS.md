...
|---|---|---|
| Condition scale | `srv/lib/condition-rating.js:62` (`legacyToBand`, `conditionLabel`, `isHighPriorityBand`, `deriveCondition`) | The ONLY condition normalisation inside value-functions (criteria #1–3). |
